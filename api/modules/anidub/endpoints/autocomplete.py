...
@router.post("/autocomplete", response_model=autocompleteSearchStrIds,  responses={404: {"model": Message}})
@inject
async def autocomplete_search_titles(text: str, service: Service = Depends(Provide[Container.service])):
